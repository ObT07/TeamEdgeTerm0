...
console.log(`Hi! My name is ${name}`, `(Data type ${typeof name})`);
console.log(`I'm in the ${grade}th grade.`, `(Data type ${typeof grade})`);
console.log(`A fun fact about me is that ${funFact}`, `(Data type ${typeof funFact})`);
...
let phrase1 = ("Happy birthday to you!");
let phrase2 = (`Happy birthday dear ${name}`);
